...
export default function Sidebar() {
  ...
  const showSuperAdminLink = user?.role === "super_admin";
  const showAdminUsersLink = user?.role === "admin";
    ...
    >
      <div className="sidebar-shell flex h-full flex-col gap-5 sm:gap-6 lg:gap-8">
        ...
        <nav className="grid grid-cols-2 gap-2 sm:grid-cols-3 lg:grid-cols-1">
          ...
          {showSuperAdminLink && renderLink("/admin", "Super Admin", "Operations")}
          {showAdminUsersLink && renderLink("/admin/users", "Admin Users", "Operations")}
        </nav>
